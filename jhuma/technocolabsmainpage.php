      ...
      <div class="nav-bar">
        ...
        <div class="nav-list">
          ...
          <ul>
            ...
            <li><a href="technoanbassador.html" data-after="anbassador"><strong>Ambassador</strong></a></li>  <!--changed by jeet : before :technoanbassador.php after : technoanbassador.html -->
