...
<!--2 changes done by jeet..-->
<?php
session_start();
$conn = new mysqli('localhost','root','','campusreg');  // changed by jeet : campusreg is name of database at my pc. //change as per pc
...
<label class="position">Don't have an account?</label> <a href="technosignup.html"> Sign up</a>  <!--change by jeet patel html file reqired for sign up form.-->
</form>
</body>
</html>
